...
public class KnifeItemBuilder extends HandheldItemBuilder {
    ...
    public KnifeItemBuilder(ResourceLocation id) {
        ...
        this.itemAttributeModifiers = KitchenKnifeItem.createAttributes(this.toolTier, this.attackDamageBaseline, this.speedBaseline);

        this.tag(new ResourceLocation[] { TagMod.KITCHEN_KNIFE.location() }); // 菜刀tag
    }
